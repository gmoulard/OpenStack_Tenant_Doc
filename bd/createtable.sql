...
# TABLE TENANTLIST(ID_T, EMAIL, ID_T, OS_AUTH_URL, OS_REGION_NAME, OS_TENANT_ID, OS_TENANT_NAME, OS_PROJECT_NAME, OS_USERNAME, OS_PASSWORD, YAMLSAVE, YAMLFILE)
# TABLE OS_API(ID_API, API_LIB, API_URL, ORDER)

# TABLE APICALL(ID_CALL, ID_T, DATE_CALL, AUTO_)
# TABLE APICALL_MEMO(ID_CALL, ID_API, VALUE_NAME, VALUE_MEMO)
# TABLE APICALLEXEC(ID_CALL, ID_API,  JSON_URLFILE, JSON_DATA)

# TABLE COMPUTE (ID_CALL, C_ID, C_NAME, ...)
# TABLE SEC_GROUP(ID_CALL, SG_ID, SG_NAME,_ ...)
